...
export interface FiddleLeaf extends Price, Shippable {
  id: number;
  name: string;
}

export const fiddleLeafFig: FiddleLeaf = {
  id: 101,
  name: "琴葉榕",
  price: 2500,
  currency: "TWD",
...
export const cartPlant: Pick<CartPlant, "id" | "name" | "price"> = {
  id: 101,
  name: "琴葉榕",
  price: 2500,
};
export const publicPlant: Omit<PublicPlant, "weightKg" | "desc"> = {
  id: 101,
  name: "琴葉榕",
  price: 2500,
  currency: "TWD",
...
export type CreateProductFn = {
  (type: SubmitType.Create, product: CreateProduct): string;
};
export type UpdateProductFn = {
  (type: SubmitType.Update, product: UpdateProduct): string;
};

export const submitProduct: CreateProductFn | UpdateProductFn = (
  type: SubmitType,
